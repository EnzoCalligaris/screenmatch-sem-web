...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        while (opcao != 0){
            var menu = """
                ...
                10 - Buscar top 5 episodios por série
    ...
    private void buscarEpisodioPorSerie(){
        ...
        if (serie.isPresent()){
            ...
            List<Episodio> episodios = temporadas.stream().flatMap(d -> d.episodios().stream().map(e -> new Episodio(d.temporada(), e))).collect(Collectors.toList());
    ...
    private void buscarSeriePorTitulo(){
        System.out.println("Digite o título da série que quer buscar: ");
        var tituloSerie = sc.nextLine();

        serieBusca= repositorio.findByTituloContainingIgnoreCase(tituloSerie);
    ...
    private void filtrarSeriesPorTemporadaEAvaliacao() {
        System.out.printf("Filtrar séries até quantas temporadas? ");
    ...
    private void buscarEpisodioporTrecho() {
        System.out.printf("Qual o nome do episódio para busca? ");
